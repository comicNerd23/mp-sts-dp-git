...
/**
 * As you can see we have separated the output() method in its own class. So, if we want add another method of output in 
 * future, we can add that in this class only and don't need to modify any other class.	
 *
 */
