...
/**
 * Liskov Substitution Principle states: Let q(x) be a property provable about objects of x of type T. Then q(y) should 
 * be provable for objects y of type S where S is a subtype of T.
 * This means that every subclass or derived class should be substitutable for their base or parent class.
 *  
 * Building off the example AreaCalculator class, consider a new VolumeCalculator class that extends the AreaCalculator:
 ...
 *		aco.outputToConsole();
 * In that case, LSP will fail because the property of calculateSum() does not give the intended result because array is
 * not convertible to double.
 * Java compiler specifically does not allow a overridden method in a child class to return a type other than that in 
 * parent class. 
 *	 
 */
