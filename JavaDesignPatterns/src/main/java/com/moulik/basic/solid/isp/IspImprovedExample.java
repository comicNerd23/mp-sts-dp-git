...
/**
 * Interface segregation principle states: A client should never be forced to implement an interface that it doesn’t use,
 * or clients shouldn’t be forced to depend on methods they do not use.
 * 
 * Still building from the previous ShapeInterface example, you will need to support the new three-dimensional shapes of 
 * Cuboid and Spheroid, and these shapes will need to also calculate volume.
 * 
 * If you see the previous example, any shape you create must implement the volume method but you know that Square and 
 * Circles are actually 2D shapes and do not have volume. So this interface would force the Square class to implement a 
 * method that it has no use of.
 * This would violate the interface segregation principle. Instead, you could create another interface called 
 * ThreeDimensionalShapeInterface that has the volume contract and three-dimensional shapes can implement this interface:
