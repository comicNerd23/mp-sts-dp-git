 ...
 *	
 * Consider an app that takes a collection of shapes - circles and squares - and calculates the sum of the area of all 
 ...
 * All of the logic would be handled by the AreaCalculator class. This would violate the single-responsibility principle. 
 * The AreaCalculator class should only be concerned with the sum of the areas of provided shapes. It should not care 
 * whether the user wants JSON or HTML.
 *
 * To address this, you can create a separate SumCalculatorOutputter class and use that new class to handle the logic you 
 * need to output the data to the user. Check SrpImprovedExample.
 *	
 */
